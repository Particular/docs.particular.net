...
#Next Steps
##Code Customization
The code generated by ServiceMatrix is meant to be customized. Review how the messages, endpoints, components and sagas can be extended by in this article. 
##Sagas for Event Correlation
In this example we reviewed saga support in a request response scenario.  In our next article we will continue to expand our system and introduce how sagas can be used to manage processes across service boundaries by correlating events. 
