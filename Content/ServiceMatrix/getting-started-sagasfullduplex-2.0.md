...
##Adding Saga Data
The saga data is made available to each handler during the life of the saga.  Locate and open the `OrderAcceptedHandlerSagaData.cs` file.  It is located in the `OnlineSale.Billing\Billing` project folder.   This partial class is initially empty but can be modified as you wish to contain data to be persisted.  
```C#
namespace OnlineSales.Billing
{
...
```
##Reviewing the SubmitPaymentHandler Code
