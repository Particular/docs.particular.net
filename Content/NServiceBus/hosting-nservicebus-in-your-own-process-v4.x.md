...
modifiedDate: 2013-09-09T17:00:34Z
authors: []
reviewers: []
contributors: []
---
...
The [Video store sample](https://github.com/Particular/NServiceBus/tree/master/Samples/VideoStore.Msmq) for v4.x.
...
-   Log4Net() tells NServiceBus what to [log](logging-in-nservicebus)
    with.
...
-   <span style="color: rgb(51, 51, 51); font-family: Consolas, 'Liberation Mono', Courier, monospace; font-size: 12px; line-height: 16px; white-space: pre;">UseTransport<msmq></span>
    ...
    (see sample
    [here](https://github.com/Particular/NServiceBus/tree/develop/Samples/VideoStore.SqlServer)
    ), ActiveMQ (see sample
    [here](https://github.com/Particular/NServiceBus/tree/develop/Samples/VideoStore.ActiveMQ)
    ), RabbitMQ (see sample
    [here](https://github.com/Particular/NServiceBus/tree/develop/Samples/VideoStore.RabbitMQ)
