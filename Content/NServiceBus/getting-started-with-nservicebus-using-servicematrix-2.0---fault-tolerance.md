...
tags: []
createdDate: 2013-09-04T09:56:45Z
modifiedDate: 2013-09-04T15:11:09Z
authors: []
reviewers: []
contributors: []
---
...
In [the previous section](getting-started-with-servicematrix.md) you've seen how a web application can send messages to a console application, see how messaging can get past all sorts of failure scenarios:
...
[Publish/Subscribe](getting-started-with-nservicebus-using-servicematrix-2.0---publish-subscribe.md)
.
