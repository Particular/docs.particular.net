...
**Version 4.0** : Starting from NServiceBus V4.0, the license file will be stored under `HKLM\\Software\\ParticularSoftware\\NServiceBus\\License` when installed using the
