...
> New projects should use the [isolated worker model](/hosting/azure/functions/worker/) instead. Follow [these instructions](/nservicebus/upgrades/azure-functions-service-bus-in-process-isolated-worker.md) to migrate.
