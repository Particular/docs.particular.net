...
See also [NServiceBus Licensing](/nservicebus/licensing/) or [licensing ServiceControl](/servicecontrol/license/) for adding a license using the ServiceControl Management app.