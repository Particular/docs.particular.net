...
**ServicePulse monitors NServiceBus endpoints for:**
 ...
 1. Audited messages: enabling auditing for all endpoints allows you to see the entire conversation for any message.
     - To enable, configure auditing for all monitored endpoints (see [auditing with NServiceBus](/nservicebus/operations/auditing.md)). Forward audit data to a single audit queue that is monitored by a ServiceControl instance.
