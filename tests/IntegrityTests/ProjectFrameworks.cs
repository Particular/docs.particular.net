...
namespace IntegrityTests
{
    public class ProjectFrameworks
    {
        ...
        public static readonly string[] sdkProjectAllowedTfmList = ["net9.0", "net9.0-windows", "net8.0", "net8.0-windows", "net7.0", "net7.0-windows", "net6.0", "net6.0-windows", "net48", "netstandard2.0"];
