...
public class Configuration
{
    ...
    public void CustomTransportName()
    {
        ...
        var azureServiceBus1 = new BridgeTransport(new AzureServiceBusTransport(connectionStringNamespace1, TopicTopology.Default))
        {
            Name = "asb-namespace-1"
        };

        var azureServiceBus2 = new BridgeTransport(new AzureServiceBusTransport(connectionStringNamespace2, TopicTopology.Default))
        {
