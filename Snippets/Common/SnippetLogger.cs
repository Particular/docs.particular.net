...
public class SnippetLogger : IDisposable
{
    ...
    public SnippetLogger([CallerFilePath] string sourceFilePath = null, string suffix = "")
    {
...
start	code {0}{1}
".Replace("\t",""), key, suffix,Path.GetFileName(sourceFilePath));
        File.AppendAllText(outputFilePath, contents);
    }

    public static void Write(string text, [CallerFilePath] string sourceFilePath = null, string suffix = "")
    {
        using (SnippetLogger logger = new SnippetLogger(sourceFilePath, suffix))
        {
