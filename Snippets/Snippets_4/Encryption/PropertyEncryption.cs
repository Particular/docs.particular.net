...
public class PropertyEncryption
{
    ...
    public void Simple()
    {
        #region EncryptionServiceSimple 4
        Configure.With()
    ...
    #region EncryptionFromIProvideConfiguration 4
    ...
    {
        #region EncryptionFromIEncryptionService 4
