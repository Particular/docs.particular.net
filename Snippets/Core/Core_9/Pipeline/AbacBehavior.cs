...
public class AbacAuthorizationBehavior(IAuthorizationService authService)
    : Behavior<IIncomingLogicalMessageContext>
{
    ...
    public override async Task Invoke(IIncomingLogicalMessageContext context, Func<Task> next)
    {
        ...
        var attributes = new Dictionary<string, object>
        {
            ...
            ["SenderId"] = headers.GetValueOrDefault("SenderId"),
            ["SecurityLevel"] = headers.GetValueOrDefault("SecurityLevel"),
            ["Timestamp"] = headers.GetValueOrDefault("Timestamp")
        };
