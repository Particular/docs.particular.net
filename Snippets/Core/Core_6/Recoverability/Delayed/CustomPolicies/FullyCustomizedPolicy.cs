namespace Core6.Recoverability.Delayed.CustomPolicies
{
    ...
    class FullyCustomizedPolicy62
    {
        FullyCustomizedPolicy62(EndpointConfiguration endpointConfiguration)
        {
            #region FullyCustomizedPolicyRecoverabilityConfiguration [6.2,)
        ...
        #region FullyCustomizedPolicy [6.2,)
