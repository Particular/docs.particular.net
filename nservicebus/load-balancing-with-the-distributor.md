...
For more information about Pub/Sub in a distributor scenario see [What the distributor does]( http://docs.particular.net/nservicebus/how-pub-sub-works#what-the-distributor-does) and [The same for any publisher node](http://docs.particular.net/nservicebus/how-pub-sub-works#the-same-for-any-publisher-node)
