...
WARNING: This persistence will run on the free version of the above engines, i.e. [SQL Server Express](https://www.microsoft.com/en-au/sql-server/sql-server-editions-express) and [MySQL Community Edition](https://www.mysql.com/products/community/). However, due to the benefits of support, it is strongly recommended to purchase a paid version for running any production system. Its is also recommended to ensure that support agreements are in place from [MySQL support](https://www.mysql.com/support/), [Microsoft Premier Support](https://www.microsoft.com/en-us/microsoftservices/support.aspx) or another third party support provider.
