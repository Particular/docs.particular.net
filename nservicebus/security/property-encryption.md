...
The encryption algorithm used is [Rijndael](https://msdn.microsoft.com/en-us/library/system.security.cryptography.rijndael.aspx) and is based on a key shared between the sender and receiver which is known as synchronous encryption.
