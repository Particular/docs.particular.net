...
>
> NServiceBus uses the [`Environment.GetFolderPath(SpecialFolder)`](https://learn.microsoft.com/en-us/dotnet/api/system.environment.getfolderpath) method to determine the locations of some paths on each OS.
