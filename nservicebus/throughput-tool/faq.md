...
The report generated by the tool may contain data for queues that should not be counted as part of a license with Particular Software. This is because naming conventions for queues vary quite a bit between different solutions, and it's easier for the licensing specialists at Particular Software with a complete picture of the entire system usage.
