...
To allow this, use [NServiceBus.MessagingBridge version 2.1 or above](configuration.md#registering-multiple-publishers-for-the-same-event) and disable best practices enforcement:
