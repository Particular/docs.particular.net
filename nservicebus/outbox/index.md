...
* The outbox works only in an NServiceBus message handler. For use outside the context of a message handler, the [TransactionalSession-package](/nservicebus/transactional-session) can be used.
