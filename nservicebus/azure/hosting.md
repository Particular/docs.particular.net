---
title: Hosting in Windows Azure
...
To learn more about enabling persistence with Windows Azure storage, refer to [Azure storage persisters](azure-storage-persistence.md).
...
To learn more about the details of hosting in windows azure cloud services, refer to [Cloud Services](hosting-in-azure-cloud-services.md).
