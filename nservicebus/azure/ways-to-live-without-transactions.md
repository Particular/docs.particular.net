...
Some NServiceBus [transports](/transports/) rely on the [Distributed Transaction Coordinator (DTC)](https://learn.microsoft.com/en-us/previous-versions/windows/desktop/ms684146(v=vs.85)) to make a distributed system reliable and to ensure consistency. In Azure, the DTC should be avoided since many services don't support distributed transactions.
