...
NOTE: When connecting to the Oracle Database, only the ODP.NET managed driver is supported. The driver is available via [Oracle.ManagedDataAccess NuGet Package](https://www.nuget.org/packages/Oracle.ManagedDataAccess).
