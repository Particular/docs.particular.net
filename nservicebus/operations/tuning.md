...
WARNING: Throughput throttling options have been depricated in NServiceBus Version 6. To achieve throttling on Version 6 and higher, a custom behavior should be used and there is a [sample](/samples/throttling/) demonstrating that.
