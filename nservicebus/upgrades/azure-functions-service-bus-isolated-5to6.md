...
The default topology options can be overridden by adding settings to the [application configuration](/hosting/azure/functions/worker/#preparing-the-azure-service-bus-namespace-topology-configuration).