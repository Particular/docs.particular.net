...
- In the Solution Explorer right click under References on the `NServiceBus.Wcf` reference and switch to properties, or use `Alt+Enter`
- Under the alias property set an alias for the assembly, i.ex. `wcf`
