...
The FirstLevelRetries and SecondLevelRetries features have been merged into a new Recoverability feature. Retries are enabled by default but can be disabled individually using:

snippet: 5to6-DisableRetries
