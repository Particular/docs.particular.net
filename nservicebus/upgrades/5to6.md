...
More information, like cancellation support, can be found on our documentation about [handling responses on the client side](/nservicebus/messaging/handling-responses-on-the-client-side).