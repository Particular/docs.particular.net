...
The option to automatically subscribe to plain messages was removed to discourage bad practices. Message subscription should only be based on events. Although not recommended, this can be overridden by [manually subscribing](http://docs.particular.net/nservicebus/messaging/publish-subscribe/controlling-what-is-subscribed#how-to-manually-subscribe-to-a-message) to other message types.
