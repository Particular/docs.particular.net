...
In previous versions of NServiceBus to start a new instance of an endpoint you would use `Bus` static class and the `IStartableBus` interface. In Version 6 these two concepts have been replaced. More information can be found in the [hosting](/nservicebus/hosting.md) section of the documentation.
