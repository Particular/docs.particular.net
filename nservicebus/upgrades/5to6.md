...
### PipelineExecutor
The `PipelineExecutor` has been removed. This has been internalized and is not accessible through the Container anymore. If you are relying on it in your code, you can leverage a Behavior. The [Version 6 guide on pipeline customization](/nservicebus/pipeline/customizing-v6.md) provides more details about custom behaviors.
