...
Use a helper class described in [Derived endpoint name behavior](/nservicebus/upgrades/5to6-endpoint-name-helper.md) to get the behavior that was previously available in Version 5.
