...
Suppressing the ambient transaction created by the MSMQ and SQL Server transports can still be acheived by creating a custom pipeline behavior with a suppressed transaction scope.
