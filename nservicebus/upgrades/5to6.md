...
Access to transaction settings is provided by the `TransactionSettings` class. We're moving away from this class and the following properties have been obsoleted.
