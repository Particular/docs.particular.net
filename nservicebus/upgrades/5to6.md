...
To determine if distributed transactions are suppressed use the following code:

snippet: 5to6IsDtcTransactionsSuppressed

#### IsTransactional

To determine if transactions are in use:

snippet: 5to6IsTransactionsEnabled
