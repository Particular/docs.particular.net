...
A common mistake when using sagas is to forget to assign a value to the saga property that is being correlated on. Version 6 will prevent this by automatically setting the correlation property value using the value from the incoming message.
