...
`MsmqMessageSender` and `MsmqSettings` are no longer available. Please refer to our documentation for [native sends](http://docs.particular.net/nservicebus/msmq/operations-scripting#native-send) for other ways of sending raw messages via MSMQ.
