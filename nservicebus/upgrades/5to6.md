...
#### Using [AzureCloudService Host](/nservicebus/azure/hosting-in-azure-cloud-services.md)
...
To access it at runtime create a new [`Feature`](/nservicebus/pipeline/features) and put the following code in the `.Setup` method 
