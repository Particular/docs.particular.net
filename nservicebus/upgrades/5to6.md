...
In previous versions of NServiceBus to start a new instance of an endpoint you would use `Bus` static class and the `IStartableBus` interface. In V6 these two concepts have been replaced. You can find more information on that subject in the [hosting](/nservicebus/hosting.md) section of the documentation.
