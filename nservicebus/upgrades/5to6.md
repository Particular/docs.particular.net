...
#### Using [AzureCloudService Host](/nservicebus/hosting/cloudservices-host/)
...
This same functionality and more can be achieved using the [message processing pipeline](/nservicebus/pipeline/customizing-v6.md). For more details, please read: [Customizing error handling with the pipeline](/nservicebus/pipeline/customizing-error-handling.md).
