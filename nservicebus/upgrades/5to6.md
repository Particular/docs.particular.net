...
<!-- import 5to6-IWantToRunWhenBusStartsAndStops -->
...
External integration systems need to make sure that they are able to deserialize messages in received in the new format.  Given the following class:
...
A null Birthdate would result in a message in the following format in v5.* and less:
```XML
<?xml version="1.0"?>
<MessageWithNullable xmlns="http://tempuri.net/NServiceBus.Serializers.XML.Test" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
   <FirstName>FirstName</FirstName>
   <BirthDate>null</BirthDate>
</MessageWithNullable>
```

And would result in the following message in v6.* and higher:
```XML
<?xml version="1.0"?>
<MessageWithNullable xmlns="http://tempuri.net/NServiceBus.Serializers.XML.Test" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
   <FirstName>FirstName</FirstName>
