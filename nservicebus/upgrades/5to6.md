...
### PipelineExecutor
The `PipelineExecutor` has been removed. It has been internalized and is not accessible through the Container. You can use a custom Behavior instead. See [Pipeline customization](/nservicebus/pipeline/customizing-v6.md).
