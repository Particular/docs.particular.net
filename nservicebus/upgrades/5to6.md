...
Instead use `context.Settings.GetRequiredTransactionSupportForReceives() != TransactionSupport.Distributed` to determine if distributed transactions is suppressed.
