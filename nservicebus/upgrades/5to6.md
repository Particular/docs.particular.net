...
A common mistake when using sagas it to forget to assign a value to the property that you're correlating the saga on. Version 6 will prevent this by enforcing that all correlation properties have a non default value when new saga instance are created. 
