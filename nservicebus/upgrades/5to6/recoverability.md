...
Once the upgrade is done the receiver can be safely [disabled](nservicebus/recoverability/configure-delayed-retries#custom-retry-policy-legacy-retries-message-receiver) and the `.Retries` queue can be safely deleted.
