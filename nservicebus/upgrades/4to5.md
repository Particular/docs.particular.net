...
If your class cannot constructed though dependency injection you can store the instance of `IBus` returned from `Bus.Create(busConfiguration).Start()` in a static variable and access it in the global context.
