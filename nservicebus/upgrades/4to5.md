...
The `RunHandlersUnderIncomingPrincipal` has been removed.
...
Another option is to use your own custom header as illustrated in [Appending username using headers](/samples/username-header/) sample.
