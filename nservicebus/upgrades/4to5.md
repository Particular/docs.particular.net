...
To move over to this NuGet after updating to Version 5:
 ...
 1. If you were using the old profile names, like `NServiceBus.Distributor`, `NServiceBus.Master` or `NServiceBus.Worker`, replace them with the new profile names, which are: `NServiceBus.MsmqDistributor`, `NServiceBus.MsmqMaster` or `NServiceBus.MsmqWorker`
