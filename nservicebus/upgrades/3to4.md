...
WARN: If a message with encoded characters is sent from Version 4 to Version 3 an exception will be thrown and that message will be forwarded to the error queue. From there it can be handled manually and retried.
