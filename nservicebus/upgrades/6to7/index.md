...
`NSerciceBus.Persistence.StorageType` has been moved to the root `NServiceBus` namespace to prevent uneeded using when specifying individual storage types explicitly.
