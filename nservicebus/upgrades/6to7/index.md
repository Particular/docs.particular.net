...
A new API called, [DisableInstaller](/transports/msmq/transportconfig.md?version=msmqtransport_1#receiving-algorithm-msmq-label) can now be used to disable the auto-creation of queues during startup.
