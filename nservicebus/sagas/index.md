...
## Querying Saga Data
Sagas manage state of potentially long-running business processes. When we are building User interfaces that represent those business processes we suddenly feel the urge to query the saga data directly. It can be done, but we recommend against it. It has the following implications:
