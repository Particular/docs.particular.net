...
summary: Extending message lock renewal
component: ASB
tags:
- Cloud
- Azure
...
For example, setting lock renewal time to 10 minutes using `LockDuration` set to 1 minute will ensure that message will remain locked up to 10 minutes, but not past that. If message processing exceeds the 10 minutes, the message will become available to other consumers.