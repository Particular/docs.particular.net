...
DANGER: if destination queue exceeds its maximum size, transaction will **NOT** fail, but the messages will not be forwarded and will dead-lettered by the broker.
