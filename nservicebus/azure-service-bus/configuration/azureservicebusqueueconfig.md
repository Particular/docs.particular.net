---
title: Azure Service Bus Queue Config Section
...
NOTE: AzureServiceBusQueueConfig is only available in Version 6 and below. `QueueName` and `QueuePerInstance` are obsoleted since version 6. Instead, use bus configuration object to specify endpoint name and scale-out option.
