...
NOTE: Discarding obsolete messages at startup should be used only in exceptional scenarios when such functionality is desired. As a general rule, it's not recommended to be used in a production environment as it may lead to subtle message loss situations.
