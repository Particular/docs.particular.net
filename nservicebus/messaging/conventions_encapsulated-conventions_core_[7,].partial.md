...
Multiple encapsulated conventions can be applied to the same endpoint. A class will be considered a message, command, or event if any convention matches it.
