...
WARN: Note that this type of callback won't cause reponse messages to end up in the [error queue](/nservicebus/recoverability) if no callback is registered since there there is no way those messages can be recovered.
