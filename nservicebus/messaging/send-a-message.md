...
NOTE: Ensure that no ghost or duplicate messages are created if this code is executed more than once by assigning the same [message identifier](/nservicebus/messaging/message-identity) to messages sent via immediate dispatch.
