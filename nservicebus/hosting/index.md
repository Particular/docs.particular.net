...
NServiceBus can be hosted in several serverless environments such as [Azure Functions](/hosting/azure/functions/worker/) and [AWS Lambda](/nservicebus/hosting/aws-lambda-simple-queue-service/).
