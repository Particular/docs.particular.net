 * `InMemory` persistence is used for storing information like sagas, subscriptions, timeouts, etc. This is a convenient option for development, but should not be used in production.
