...
Assembly scanning is not available in this hosting model because a single Functions app can host [multiple endpoints](/nservicebus/hosting/core-hosting#hosting-multiple-endpoints). As a secondary effect, avoiding assembly scanning also improves cold startup times.
