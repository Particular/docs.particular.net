...
> [!NOTE]
> This document does not apply to Azure Function hosts. For Azure Function hosts, see [Azure Function Isolated Worker diagnostics](/hosting/azure/functions/worker/#configuration-startup-diagnostics).
