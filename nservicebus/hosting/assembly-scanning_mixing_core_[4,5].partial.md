...
`AllAssemblies` helper class can be used to create a list of assemblies either by creating a denylist using the method `Except` or a allowlist by using Matching or a combination of both.
