...
Starting in version XXX of `NServiceBus.AzureFunctions.Worker.ServiceBus`, warning CS8032 is treated as an error. To suppress this error, update your project's .csproj file to include the following line in the `<PropertyGroup>` section at the top:
