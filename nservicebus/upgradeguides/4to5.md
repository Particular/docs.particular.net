...
See [Using RavenDb in NServiceBus](http://docs.particular.net/nservicebus/using-ravendb-in-nservicebus-installing) for additional details on upgrading from Raven 2.0 to 2.5.
