...
See [Using RavenDb in NServiceBus](/nservicebus/using-ravendb-in-nservicebus-installing.md#upgrading-ravendb) for additional details on upgrading from Raven 2.0 to 2.5.
