...
Before scaling out via the distributor make sure that the [**MaximumConcurrencyLevel** has been increased in the configuration](/nservicebus/operations/tuning#tuning-concurrency) on the distributor endpoint. 
