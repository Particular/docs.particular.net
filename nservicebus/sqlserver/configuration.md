...
Callbacks and consequently, callback queues (secondary queues) receivers are enabled by default. In order to disable them, one must use the configuration API:
