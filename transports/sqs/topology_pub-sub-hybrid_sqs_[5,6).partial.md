...
The default values of cache invalidation and message visibility timeouts can be changed using publish-subscribe compatibility mode [settings](/transports/sqs/configuration-options.md#message-driven-publishsubscribe-compatibility-mode).