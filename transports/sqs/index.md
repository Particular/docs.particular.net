 ...
 * Can send and receive large messages, that exceed the queues limitations, by storing large payloads in S3. For more information take a look at the transport [topology](topology.md#s3) and [configuration options](configuration-options.md) documentation.
