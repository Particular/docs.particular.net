...
To assist with troubleshooting, the NServiceBus message Id is propagated to the underlying SQS message as a message attribute. That way, even if message deserialization fails, the NServiceBus message Id is still available to help diagnose problems.
