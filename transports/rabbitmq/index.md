...
summary: Integrate NServiceBus with RabbitMQ transport for scalable messaging and reliable distributed communication
reviewed: 2026-09-18
component: Rabbit
related:
...
The RabbitMQ Transport provides support for sending messages over [RabbitMQ](https://www.rabbitmq.com/) using the [RabbitMQ .NET Client](https://www.nuget.org/packages/RabbitMQ.Client/).
...
|Scripted Deployment        |Supported using `NServiceBus.Transport.RabbitMQ.CommandLine`
 ...
 * Supports a wide range of [clients](https://www.rabbitmq.com/devtools.html) which allows for integrating the system with applications written in other languages using native RabbitMQ features.
