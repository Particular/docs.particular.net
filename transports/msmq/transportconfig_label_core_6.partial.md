...
WARNING: This feature was added in version 6 and can be used to communicate with version 5 (and higher) endpoints. However it should **not** be used when communicating with earlier versions (2, 3 or 4) since in those versions the MSMQ Label was used to communicate certain NServiceBus implementation details.
