...
NOTE: In version 5.4 a [solution was introduced](/transports/sqs/topology.md?version=sqs_5.4#sqs-publishsubscribe-backwards-compatibility) where the NServiceBus SQS transport could be throttled by AWS.
