...
When using this mode all handlers must be [idempotent](/nservicebus/concepts/concept-overview.md#idempotence). In other words the result needs to be consistent from a business perspective even when the message is processed more than once.
