...
Creating this envelope can cause unnecessary complexity if headers are not needed, for example, in native integration scenarios. For this reason NServiceBus.Azure.Transports.WindowsAzureStorageQueues 7.1 and above support configuring a custom envelope unwrapper.
