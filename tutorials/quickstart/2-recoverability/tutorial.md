...
summary: In the second step of the quick start tutorial, we review how to handle failures.
extensions:
- !!tutorial
  nextText: "Next: Extend an NServiceBus system"
  nextUrl: tutorials/quickstart/3-adding-an-endpoint
previewImage: add-shipping-endpoint.png
---

TODO: Transition from previous tutorial
