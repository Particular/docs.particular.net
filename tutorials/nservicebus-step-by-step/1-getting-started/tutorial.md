...
When setting up the configuration you can chose how you want to serialize and deserialize your messages. For this tutorial, we will be specifically configuring the endpoint to use a JsonSerializer.
