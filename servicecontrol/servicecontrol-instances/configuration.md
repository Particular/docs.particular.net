...
> [!NOTE]
> Begining with version 6.5.0, these configuration settings are no longer used. Access to the managment API is configured using [connection string options](/servicecontrol/transports.md#rabbitmq). See the [ServiceControl 6.4 to 6.5 upgrade guide](/servicecontrol/upgrades/6.4to6.5.md) for more information.
