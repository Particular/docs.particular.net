...
An example of how to set encryption per specific message property can be viewed in the [VideoStore sample](/platform/samples.md) and the [Encryption Sample](/samples/encryption/sample.md).   
