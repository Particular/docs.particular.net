...
Upgrading ServiceControl from version 1 to version 2 is a major upgrade and requires careful planning. During the upgrade process, your instance of ServiceControl will no longer be available and will not be ingesting any messages. The upgrade process is not reversible and cannot be undone once started.
...
WARN: This upgrade process is intrusive and may take a long time to progress. Our tests show that upgrading a 300Gb database can take upwards of nearly 5 hours on XXXXX IOPs drives.
