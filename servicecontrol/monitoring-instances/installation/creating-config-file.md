...
If using [AmazonSQS transport](/transports/sqs/) with queue name prefixes, then only the monitoring instance setting needs to be modified to include the queue name prefix in the queue address.
