...
2. Add a new version 2 instance of ServiceControl, which has a new unique name, and configure it to ingest messages from the error and audit queues that the version 1 instance was previously configured to ingest messages from.
