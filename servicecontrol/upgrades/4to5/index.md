...
2. To preserve audit data, install a new Audit instance that uses RavenDB 5 persistence as described in [Replacing Audit instances](../replacing-audit-instances/), if this has not already been done.
