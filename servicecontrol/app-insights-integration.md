...
## Endpoint-level performance and health metrics <!-- TODO: This should be moved somewhere else, perhaps somewhere under monitoring. -->
...
## Distributed tracing <!-- TODO: This should be moved somewhere else, perhaps somewhere under monitoring. -->
...
## System-level health events <!-- TODO: If the above 2 things are removed, this can be moved to the contracts.md >
