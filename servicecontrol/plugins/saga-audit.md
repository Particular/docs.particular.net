...
The SagaAudit plugin enables the [Saga View feature in ServiceInsight](http://docs.particular.net/serviceinsight/#the-saga-view). It is built specifically to help developers verify Saga logic during development. It does that by capturing Saga message behavior and changes in Saga data/state as the Saga is being processed. It then sends this information to a ServiceControl endpoint setup in your development environment.
