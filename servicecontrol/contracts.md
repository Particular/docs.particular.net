...
WARNING: ServiceControl sends external notification events in batches. If a problem is encountered part way through a batch, the entire batch will be resent. This can result in receiving mutliple events for a single notification. 
