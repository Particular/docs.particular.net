...
WARNING: ServiceControl event publishing mechanism is not compatible with Azure Service Bus Forwarding [topology](/transports/azure-service-bus/topologies.md) and RabbitMQ Direct and custom [topologies](/transports/rabbitmq/routing-topology). With these transports the endpoint subscribing to ServiceControl events has to use  the Endpoint Oriented and Conventional topologies respectively.
