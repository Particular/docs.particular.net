...
Similarly, when [ServiceControl is installed on a cluster](/servicecontrol/deploying-servicecontrol-in-a-cluster.md), `queuename@clustername` addresses must be used.
