...
![ServiceControl Management showing the current database location in the instance details](managementutil-instance-datapath.png 'width=500')
...
After restarting, the RavenDB embedded server uses the database at the specified path.
