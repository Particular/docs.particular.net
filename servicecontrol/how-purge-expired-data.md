...
> [!WARNING]
> The database will not automatically shrink in size after reducing the retention period. Ensure ServiceControl had time to purge all expired messages and then [compact the database](db-compaction-v5.md). <!-- TODO: No link for previous versions? -->

## Differences in message retention implementations <!-- TODO: Is this needed since supported versions are > 4.26? -->
