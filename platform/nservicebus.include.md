...
In high volume scenarios, where there are more messages being produced than a single endpoint can handle, each endpoint can be [scaled out across multiple instances](/transports/scale-out.md) running on different machines, sharing the load. 
