...
NOTE: The NServiceBus.Metrics.PerformanceCounters package is only available for Windows. Newer projects may benefit more from monitoring via [OpenTelemetry](https://docs.particular.net/nservicebus/operations/opentelemetry).
