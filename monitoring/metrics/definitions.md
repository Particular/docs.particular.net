...
> [!NOTE]
> This is almost identical to the terms [dwell time (used by Amazon SQS)](https://aws.amazon.com/sqs/faqs/) or [sojourn time (queueing theory)](https://en.wikipedia.org/wiki/Queueing_theory), except these exclude the time where the message is batched in-memory, then dispatched to the transport, and committed.
