...
The [AWS Loan Broker showcase](/samples/showcase/loan-broker-showcase/) demonstrates how to integrate the Particular Service Platform and OpenTelemetry metrics and traces when hosting solutions in AWS.
