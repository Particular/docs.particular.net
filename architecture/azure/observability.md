...
For step-by-step guidance on configuring metrics, tracing, and logging with Application Insights, see [Monitoring NServiceBus with Application Insights](/architecture/azure/application-insights.md).
