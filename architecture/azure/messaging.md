...
- The [Azure LoanBrokwer showcase](/samples/showcase/loan-broker-showcase/) demonstrates how to implement some of the presented messaging patterns using Azure Service Bus
