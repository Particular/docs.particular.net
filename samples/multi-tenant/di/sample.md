...
This sample simulates a multi-tenant solution in which the session provided to handlers is connected to the individual tenant databases based on the value of a `tenant` header in the incoming message.
