...
public class OrderAcceptedHandler : IHandleMessages<OrderAccepted>
{
    ...
    public Task Handle(OrderAccepted message, IMessageHandlerContext context)
    {
        ...
        log.InfoFormat($"Order # {message.OrderNumber} has been accepted, Let's provision the download -- Sending ProvisionDownloadRequest to the Store.Operations endpoint");
