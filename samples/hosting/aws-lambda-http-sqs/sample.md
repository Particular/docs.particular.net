---
title: NEW STUFF Using NServiceBus in AWS Lambda with SQS
reviewed: 2023-07-28
component: SQSLambda
related:
 - samples/sqs
...
MORE NEW STUFF ======== This sample shows how to host NServiceBus within an AWS Lambda, in this case, a function triggered by incoming SQS messages. This enables hosting message handlers in AWS Lambda, gaining the abstraction of message handlers implemented using `IHandleMessages<T>` and also taking advantage of NServiceBus's extensible message-processing pipeline.
