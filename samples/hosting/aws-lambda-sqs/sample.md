...
There could be the need to dispatch a message after reacting to events other than messages being pushed in a queue. For example, responding to an S3 bucket file upload or to an HTTP request. This sample also demonstrates this use case.
