    ...
    IHandleTimeouts<CancelOrder>
{
    ...
    {
        ConfigureMapping<StartOrder>(sagaData => sagaData.OrderId, message => message.OrderId);
        ConfigureMapping<CompleteOrder>(sagaData => sagaData.OrderId, message => message.OrderId);
    }
