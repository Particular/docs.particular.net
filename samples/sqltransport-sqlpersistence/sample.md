...
If you open the Sender and Receiver project directories in Windows File Explorer, you can view the SQL scripts generated by the SQL persister at build time in the `bin\Debug\NServiceBus.Persistence.Sql` directory.