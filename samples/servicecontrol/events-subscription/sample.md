...
Same applies to [Azure Storage Queues](/transports/azure-storage-queues) name [shortening strategy](/transports/azure-storage-queues/sanitization#backward-compatibility-with-versions-7-and-below)
