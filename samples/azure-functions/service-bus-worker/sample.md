...
To use the sample, the endpoint queue must be created. It can be done manually in the Azure portal, or with the [Azure CLI](https://learn.microsoft.com/en-us/cli/azure/install-azure-cli). In this sample, the queue name is `ASBWorkerEndpoint`.
