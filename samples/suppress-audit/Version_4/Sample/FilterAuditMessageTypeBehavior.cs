...
public class FilterAuditMessageTypeBehavior : IBehavior<ReceivePhysicalMessageContext>
{
    string location;

    public FilterAuditMessageTypeBehavior(StreamStorageSettings storageSettings)
    {
