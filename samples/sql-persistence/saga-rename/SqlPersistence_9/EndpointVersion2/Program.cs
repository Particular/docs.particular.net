...
logger.LogInformation("    from Samples_RenameSaga_MyReplySagaVersion1 to Samples_RenameSaga_MyReplySagaVersion2");
logger.LogInformation("    from Samples_RenameSaga_MyTimeoutSagaVersion1 to Samples_RenameSaga_MyTimeoutSagaVersion2");
...
logger.LogInformation("Waiting to receive timeout and reply. Should happen within 10 seconds");
