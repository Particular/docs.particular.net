...
This sample shows how to use the recoverability [error notifications](https://docs.particular.net/nservicebus/recoverability/subscribing-to-error-notifications) to capture the following:
