...
public class HomeController : Controller
{
    ...
    public async Task<ActionResult> SendEnumMessage()
    {
        ...
        Task<Status> statusTask = MvcApplication.BusContext.Request<Status>(message, sendOptions);
    ...
    public async Task<ActionResult> SendIntMessage()
    {
        ...
        SendOptions sendOptions = new SendOptions();
        sendOptions.SetDestination("Samples.Callbacks.Receiver");
        Task<int> statusTask = MvcApplication.BusContext.Request<int>(message, sendOptions);
    ...
    public async Task<ActionResult> SendObjectMessage()
    {
        ...
        SendOptions sendOptions = new SendOptions();
        sendOptions.SetDestination("Samples.Callbacks.Receiver");
        Task<ObjectResponseMessage> responseTask = MvcApplication.BusContext.Request<ObjectResponseMessage>(message, sendOptions);
