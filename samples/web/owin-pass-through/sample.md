...
The endpoint configuration is fairly standard. The one exception is that the instance of `IEndpointInstance` (in version 6) or `IBus` (in version 3-5) is passed in to the OWIN configuration code.
