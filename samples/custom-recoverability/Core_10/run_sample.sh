...
dotnet Server/bin/Debug/net10.0/Server.dll > server_normal.log 2>&1 &
SERVER_PID=$!
...
expect << 'EOD'
spawn dotnet Client/bin/Debug/net10.0/Client.dll
...
dotnet Server_Fault/bin/Debug/net10.0/Server.dll > server_fault.log 2>&1 &
SERVER_FAULT_PID=$!
