...
WARNING: When running sample, do not stop execution from Visual Studio, but instead stop cloud service from Azure Compute Emulator UI. Do to an issue with Azure Compute Eulator not invoking OnStop method, multi hosted endpoints are not terminated.
