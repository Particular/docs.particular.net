...
class EmitNServiceBusMetrics : Feature
{
    ...
    public static readonly Histogram<double> ProcessingTime =
        NServiceBusMeter.CreateHistogram<double>("nservicebus.messaging.processing_time", "s", "The time in milliseconds between when the message was pulled from the queue until processed by the endpoint.");

    public static readonly Histogram<double> CriticalTime =
        NServiceBusMeter.CreateHistogram<double>("nservicebus.messaging.critical_time", "s", "The time in milliseconds between when the message was sent until processed by the endpoint.");
