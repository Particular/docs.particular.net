...
[PostGIS](https://postgis.net/) and [NetTopologySuite](https://github.com/NetTopologySuite/NetTopologySuite) are a popular extension. Please read the [PostGIS/NetTopologySuite Type Plugin guidance at npgsql.org](https://www.npgsql.org/doc/types/nts.html) on how to setup these extensions with PostgreSQL.
